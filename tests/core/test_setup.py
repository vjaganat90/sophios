...
# Read the config when one exists; otherwise use the basic config in memory.
# io.get_config would *write* ~/wic/global_config.json and copy adapters on a
# fresh machine — collection must not provision anyone's home directory.
