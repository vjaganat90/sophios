...
MESSAGE = "hello from compute payload workflow"
VALIDATE_TOOL = True
OUTPUT_PATH = Path("autogenerated/compute_payload_workflow_demo.json")
...
def main() -> int:
    ...
    if SUBMIT_URL is None:
        return 0
    return submit_compute_payload(payload, SUBMIT_URL)
