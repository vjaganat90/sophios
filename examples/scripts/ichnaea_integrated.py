...
def main() -> int:
    ...
    if SUBMIT_URL is None:
        print(
            ...
            f"and compute_{workflow_name}_integrated.json. Set SUBMIT_URL to submit the JSON payload."
        )
        return 0

    # =========  SUBMIT TO COMPUTE ===================
    submission_status: int = submit_compute_json(compute_json, SUBMIT_URL)
